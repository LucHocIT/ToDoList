...
public class CalendarViewHelper {
    ...
    public static void loadMonthCalendar(Context context, GridLayout calendarGrid, 
        ...
        for (int day = 1; day <= daysInMonth; day++) {
            ...
            boolean hasTasksForDay = hasTasks(database, currentCalendar.get(Calendar.YEAR), 
    ...
    public static void loadWeekView(Context context, LinearLayout weekGrid, 
        ...
        for (int i = 0; i < 7; i++) {
            ...
            TextView dayView = createWeekDayView(context, dayCalendar, selectedDate, database);
    ...
    private static TextView createWeekDayView(Context context, Calendar dayCalendar, 
                                            Calendar selectedDate, TodoDatabase database) {
        ...
        boolean hasTasksForDay = hasTasks(database, dayCalendar.get(Calendar.YEAR), 
    ...
    private static boolean hasTasks(TodoDatabase database, int year, int month, int day) {
