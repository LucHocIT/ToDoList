...
public class SectionManager {
    ...
    public void updateSectionVisibility(List<TodoTask> filteredOverdueTasks, List<TodoTask> filteredTodayTasks,
                                       List<TodoTask> filteredFutureTasks, List<TodoTask> filteredCompletedTodayTasks) {
